 ...
 * Salvata prima del revert del commit 658d5ba (Privacy Policy).
 * Contiene: aggiunta Stripe come sub-responsabile pagamenti (dati carta,
 * finalità fatturazione, trasferimento USA).
