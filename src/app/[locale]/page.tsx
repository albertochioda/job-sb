...
export default async function HomePage({
  ...
  return (
    <main className="flex flex-col min-h-screen">
      ...
      {/* Hero — due colonne, si impila su mobile */}
      <section className="px-6 py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-[1.1fr_1fr] gap-10 items-center max-w-5xl mx-auto">
          <div>
            <h1 className="text-3xl md:text-5xl font-medium leading-tight mb-4 max-w-xl">
              {heroHeadline}
            </h1>
            ...
            <Link
              href="/register"
              className="inline-block bg-primary text-primary-foreground px-6 py-2.5 rounded-lg text-sm font-medium hover:bg-primary/90"
            >
              {t("cta")}
            </Link>
          </div>
